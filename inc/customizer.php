...
if ( class_exists( 'Customizer_Library' ) ) :
  ...
  include trailingslashit( get_template_directory() ) . 'inc/customizer-upsell.php';
  ...
  add_action( 'customize_register', 'gannet_customize_register', 110 );
